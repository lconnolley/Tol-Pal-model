...
%z_1 = load('../Experimental/TolB_nondiv_2s.mat');
%z_2 = load('../Experimental/TolB_dividing_nopeaks.mat');
z_1 = load('../Experimental/Pal_nondividing_30s.mat');
z_2 = load('../Experimental/Pal_dividing_30s.mat');
z_3 = load('../Experimental/tolA_dividing.mat');
z_4 = load('../Experimental/tolB_dividing.mat');
